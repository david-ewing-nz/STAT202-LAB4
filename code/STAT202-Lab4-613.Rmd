...
Centring variables (weight_c and weight_c2) improve symmetry, reduce extreme ranges, enhance visuals, and address multicollinearity. The opposite slopes for height vs weight2 and height vs weight_c2 are because centring changes the reference point of the quadratic term to the mean. This reduces the dependency between the linear (weight_c) and quadratic (weight_c2) terms, providing better scaling and stability in the regression models. Centring appears to be necessary when exploring the introduction of a quadratic term.

---

\newpage

# Step7: Fit m4 with weight_c, weight_c2, and sex as predictors

```{r step7_final_table_fixed, echo=TRUE, message=FALSE, warning=FALSE}
# m4 model
...
vif_combined_flex <- flextable(vif_combined_transposed) %>%
  ...
  align(j = 2:ncol(vif_combined_transposed), align = "center", part = "all") %>%  # Center-align other columns
